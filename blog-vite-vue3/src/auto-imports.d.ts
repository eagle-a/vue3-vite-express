...
export {}
declare global {
  const ArticleCard: typeof import('./components/index')['ArticleCard']
  const AuthModal: typeof import('./components/index')['AuthModal']
  ...
  const Navbar: typeof import('./components/index')['Navbar']
  const SearchBox: typeof import('./components/index')['SearchBox']
  const Sidebar: typeof import('./components/index')['Sidebar']
  const ThemeToggle: typeof import('./components/index')['ThemeToggle']
