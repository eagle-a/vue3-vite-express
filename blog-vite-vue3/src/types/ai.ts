...
export interface response_format {
...
export interface ModelAiptions {
...
export interface CompletionRequest extends ModelAiptions {
    model: string // 模型的标识符
...
export interface logprobs_content {
    token: string
    logprob: number
    bytes: number
    top_logprobs: {
